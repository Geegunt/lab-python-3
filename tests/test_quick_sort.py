...
class TestQuickSort:
    def test_basic(self):
        ...
        assert sorter.quick_sort() == [1, 2, 3, 7, 9]
    ...
    def test_all_same(self):
        ...
        assert sorter.quick_sort() == [5, 5, 5, 5]


class TestQuickSortEnhanced:
